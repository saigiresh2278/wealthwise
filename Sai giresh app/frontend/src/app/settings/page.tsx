...
import { Moon, Sun, User, Shield, AlertTriangle, Trash2, LogOut, ArrowRight } from "lucide-react"
        ...
        <div className="glass-card p-5">
          ...
          <button onClick={toggleDarkMode}
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white text-sm">{darkMode ? "Light Mode" : "Dark Mode"}</span>
            </div>
          ...
          <div className="space-y-2">
            ...
            <Link href="/risk-analyzer"
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white text-sm">Retake Risk Assessment</span>
              </div>
              <ArrowRight size={16} className="text-gray-500" />
            </Link>
          </div>
